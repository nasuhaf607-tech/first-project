...
const Register = () => {
  ...
  const userTypes = [
    { value: 'OKU User', label: 'OKU User (Passenger)', icon: '🧑‍🦽' },
    { value: 'Driver', label: 'Driver', icon: '🚗' },
    { value: 'Company Admin', label: 'Company Admin', icon: '🏢' },
    { value: 'JKM Officer', label: 'JKM Officer', icon: '🏛️' }
  ];
            ...
            <div>
              ...
              {formData.userType === 'Driver' && (
                <p className="mt-2 text-sm text-yellow-600 bg-yellow-50 p-2 rounded">
                  ⚠️ Driver applications require JKM approval before you can start accepting bookings.
                </p>
              )}
            </div>
